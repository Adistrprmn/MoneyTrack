...
export default function Landing() {
  ...
  return (
    <div className="landing-page min-h-screen bg-paper dark:bg-[#0F1715] text-ink dark:text-white transition-colors duration-300">
      ...
      <header className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 py-6 flex items-center justify-between">
